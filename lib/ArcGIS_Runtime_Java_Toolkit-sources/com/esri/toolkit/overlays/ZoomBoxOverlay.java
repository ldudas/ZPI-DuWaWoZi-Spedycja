...
/**
 * This class is a map overlay which, when active, draws a rectangle on 
 * the map on mouse click-and-drag, then sets the extent of the map to 
 * the extent of the drawn rectangle when the mouse button is released.
 *
 * @since 10.2.3
 * 
 * @usage
 * <code>
 * ZoomBoxOverlay zoomBoxOverlay = new ZoomBoxOverlay();<br>
 * jMap.addMapOverlay(zoomBoxOverlay);<br>
 * </code>
 */
