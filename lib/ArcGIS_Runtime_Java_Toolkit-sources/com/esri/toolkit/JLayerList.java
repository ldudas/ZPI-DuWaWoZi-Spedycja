...
/**
 * A UI component to display a list of all layers of a map.
 * @usage
 * <code>
 * <pre>
 * JLayerList jLayerList = new JLayerList(jMap);
 * contentPane.add(jLayerList, BorderLayout.WEST); // adds to a component with border layout
 * </pre>
 * </code>
 * @since 10.2.3
 */
