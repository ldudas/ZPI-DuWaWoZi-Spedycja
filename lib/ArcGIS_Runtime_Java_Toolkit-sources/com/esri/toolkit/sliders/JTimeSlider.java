...
import com.esri.toolkit.sliders.RangeSlider.RangeMode;
 ...
 * jTimeSlider.setTitle("Timeline");
 * jTimeSlider.addLayer(layer); // any TimeAwareLayer
...
public class JTimeSlider extends JPanel {
    ...
    /**
     * The time modes that can be set for the time slider.
     */
    public enum TimeMode {
        
        /** 
         * Represents a fixed start date that does not change and an end date that can change.
         */
        CumulativeFromStart,
        
        /** 
         * Represents a start date that can change and an end date that can also change.
         */
        TimeExtent,
        
        /** 
         * Represents a start date and end date that are always the same date.
         */
        TimeInstant
    }
    ...
    /**
     * Sets the current {@link TimeMode} of the control.
     *
     * @param timeMode
     ...
     * for that step.
     * <p/>
     * Note that the time extent includes the start date and excludes the end
